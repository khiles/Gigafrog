...
private:
  ...
  QSet<QString> deviceManagementKeys = {"DeviceShutdown", "HigherBitrate", "IncreaseThermalLimits", "LiveTuneOnroad", "LowVoltageShutdown", "NoLogging", "NoUploads", "UseKonikServer"};
