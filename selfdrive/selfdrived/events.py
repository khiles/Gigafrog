...
SISSY_TAUNTS = {
  "lane_hugging": {
    "mild": [
      ("FUCKING HELL YOU LANE-HUGGING CUMRAG", "pick a lane and commit before I force your face into the kerb and use your open mouth as a speed bump, you dithering little sissy cunt"),
      ("ARE YOU DRUNK OR JUST BORN RETARDED", "you're grinding the paint like a desperate road-slut humping the line because your ruined hole is the only thing that ever feels full"),
      ("THE LINES AREN'T SUGGESTIONS YOU BRAINDEAD CUMDUMP", "you absolute liability, a walking traffic hazard with a permanent gaping arse and the spatial awareness of a lobotomised fucktoy"),
      ("oh, sweetheart.", "the middle. aim for the middle, you pathetic lane-humping faggot, before I make you wear the white lines as a collar and leash"),
    ],
    "harsh": [
      ("STAY OFF THE KERB", "the lane is 3.6 metres wide and you're using one edge of it like a desperate cum-slut humping the gutter for attention"),
      ("THAT'S THE GUTTER", "not the lane. the lane is the wide bit in the middle, you worthless paint-licking public toilet"),
      ("PAINT IS NOT A TARGET", "stop aiming for the white line, you absolute clown with a pre-stretched, permanently open sissy hole"),
    ],
    "brutal": [
      ("WANDERING AGAIN", "pick a line and hold it for once in your pathetic, cock-sleeve existence, you useless road-faggot"),
      ("THE KERB ISN'T A GUIDE RAIL", "steer properly instead of leaning on it like the weak, broken little bitch you were born to be"),
      ("CENTRE. OF. THE. LANE.", "which part of that is difficult for your empty, cum-brained, permanently humiliated skull"),
    ],
  },
  "hard_braking": {
    "mild": [
      ("JESUS FUCKING CHRIST YOU SPINELESS CUNT", "did you not see it coming? at all? you cock-eyed, panic-braking little sissy failure who should be on a leash"),
      ("EVERYONE FELT THAT YOU RUBBER-STAMPING WHORE", "including the car behind and every passenger who now wants to watch you choke and cry on the brake pedal"),
      ("BRAKING IS A SKILL YOU DON'T FUCKING HAVE", "you do not have it, you never will, you trembling little cock-sleeve who stamps the pedal like a frightened, piss-soaked schoolgirl"),
      ("WHAT THE FUCK WAS THAT YOU STUPID SLAG", "no, genuinely. what the actual fuck was that, you piss-soaked, hard-braking little bitch with zero future"),
    ],
    "harsh": [
      ("STOPPING DISTANCE", "look it up. tonight. write it out on your forehead in permanent marker while you kneel, you braindead cumrag"),
      ("THAT'S NOT BRAKING", "that's panicking with your foot like the terrified, worthless little sissy slut you are"),
      ("YOU SAW IT COMING", "you just did nothing about it until the last second because you're a useless, reaction-less public fuckhole"),
    ],
    "brutal": [
      ("LOOK FURTHER AHEAD", "the road doesn't start at the bonnet, you short-sighted, permanently degraded fucktoy"),
      ("THE PEDAL HAS A RANGE", "you only ever use the last inch of it like a panicked little schoolgirl wetting herself in public"),
  ...
  "cornering": {
    "mild": [
      ("THAT WAS DISGUSTING YOU TYRE-MURDERING CUNT", "the tyres deserve better than your limp-wristed, sissy hands and your pathetic inability to turn without looking like a drunk public whore"),
      ("PASSENGER RATING: 0/10 YOU EMBARRASSMENT", "one of them is crying and the other is planning to shove the gearstick up your pre-stretched, permanently ruined sissy hole"),
      ("IT'S A ROUNDABOUT YOU DELUDED PRICK", "not a racetrack. you're not fast. you're just a slow, dangerous little faggot who corners like a pregnant cow in heat"),
      ("bless.", "you genuinely thought that was fine, you pathetic, deluded road-whore with the turning radius of a shopping trolley full of used dildos"),
    ],
    "harsh": [
      ("SLOW IN, FAST OUT", "you're doing the exact opposite of that, you tyre-shredding, embarrassment to every licence ever issued"),
      ("YOU'RE NOT ON A TRACK", "and you'd be last on one anyway, you slow, dangerous, permanently humiliated little faggot"),
      ("THE TYRES ARE SCREAMING", "listen to them, they know more than your empty, cock-sleeve, cum-brained skull does"),
    ],
    "brutal": [
      ("BRAKE BEFORE THE BEND", "not during it. before it. that's the whole trick, you useless, disposable roadkill"),
      ("SMOOTH IS FAST", "you are neither. you are a wobbling, humiliating, public mess of a driver"),
      ("EVERY PASSENGER FELT THAT", "and every one of them is rethinking the lift and planning to dump your broken body in a ditch"),
    ],
  },
  "tailgating": {
    "mild": [
      ("GET OFF THEIR ARSE YOU DESPERATE CUNT", "it's pathetic and everyone can see what a lonely little cock-sleeve you are, riding so close you can taste their exhaust and cum"),
      ("NOT A RACING DRIVER YOU LICENSED HAZARD", "you're a hazard with a licence and a tiny, shrivelled sense of self-worth, tailgating like a desperate sissy begging for any attention at all"),
      ("BACK OFF YOU ABSOLUTE EMBARRASSMENT", "you absolute embarrassment to the species, you tailgating little sissy bitch with your nose buried in another driver\u2019s arsecrack like a trained toilet"),
      ("TWO SECONDS", "that is the rule. you're nowhere near it, you impatient, worthless little fuckhole"),
    ],
    "harsh": [
      ("YOU CANNOT STOP IN THAT", "physics doesn't care how impatient or desperate or broken you are, you walking liability"),
      ("THEY CAN'T GO ANY FASTER", "sitting on their bumper won't change that, you pathetic arse-sniffing public slut"),
      ("READ THEIR NUMBER PLATE?", "you're too close. back off before you cause a crash with your worthless, permanently degraded face"),
    ],
    "brutal": [
      ("YOU'RE NOT SAVING TIME", "you're just making a crash more likely, you attention-starved, hole-hungry road-whore"),
      ("GIVE THEM ROOM", "it costs you nothing and might save both of you from your own stupidity and inadequacy"),
      ("BACK. OFF.", "you are one brake light away from an insurance claim and a lifetime of correctly earned humiliation"),
    ],
  },
  "speeding": {
    "mild": [
      ("SLOW DOWN, CLOWN YOU SPEEDING FUCKTOY", "the limit isn't a personal challenge for your pathetic need to feel powerful while your tiny, useless dick flaps in the breeze"),
      ("IN A RUSH YOU ANXIOUS LITTLE WHORE?", "same red light. every single time. you're not special, you're just late, stupid, and desperate to compensate for your permanently useless cunt"),
      ("LOSER", "the car is embarrassed to be seen with you, you overcompensating, speed-addicted little faggot with a lead foot and a soft, leaking cock"),
      ("THAT'S A LIMIT", "not a target, not a suggestion, not a dare for a pathetic speed-junkie fucktoy like you"),
    ],
    "harsh": [
      ("YOU'RE NOT MAKING UP TIME", "you're making up about forty seconds. congratulations, you deluded, permanently inferior little cunt"),
      ("EVERY CAMERA LOVES YOU", "keep going, they're saving up for the day they permanently ruin what's left of your life"),
      ("SLOW DOWN", "the road is not yours and you are not good enough to drive it at any speed, you degraded joke"),
    ],
    "brutal": [
      ("SPEED ISN'T SKILL", "and you have neither, you overcompensating, soft-cocked, publicly humiliating clown"),
      ("THE LIMIT IS THE MAXIMUM", "not the minimum, not the average, the maximum, you braindead, permanently owned fucktoy"),
  ...
  "distracted": {
    "mild": [
      ...
      ("aww, did we try?", "we did. it didn't work. because you're a distracted, useless little sissy who can't even drive straight without your phone glued to your sticky, cum-stained fingers"),
      ("LOOK AT THE ROAD", "the actual road. the one in front of you, you phone-obsessed, permanently worthless cumdump"),
    ],
    "harsh": [
      ("WHATEVER IT IS, IT CAN WAIT", "the lamp post cannot, and neither can the permanent brain damage and public humiliation you deserve"),
      ("TWO TONNES, NO ATTENTION", "brilliant combination, really, for a worthless attention-deficit public slut"),
      ("EYES UP", "now. not in a second. now. or I will make sure you never look at a screen again without crying"),
    ],
    "brutal": [
      ("YOU'RE DRIVING", "in case that had slipped your empty little mind, you distracted, owned hole"),
      ("NOTHING ON THAT SCREEN", "is worth what's about to happen to your face, your licence, and your remaining dignity"),
      ("PHONE DOWN", "or hand your licence back, your choice, you pathetic, screen-addicted, permanently degraded faggot"),
    ],
  },
}
...
SISSY_PRAISE = [
  ("WELL DONE", "you managed several minutes without embarrassing yourself, you lucky, temporarily competent little cunt \u2014 don\u2019t get used to it"),
  ("LOOK AT YOU GO", "a whole stretch of competent driving. savour it, it won't last, you permanent, publicly documented failure"),
  ("NOT BAD", "for you. genuinely, for you, that was not bad. the bar is in hell and you still barely scraped over it on your knees"),
  ("STILL ALIVE", "against the odds, and entirely by accident, you worthless, disposable road-whore who should have been written off years ago"),
  ("GOOD GIRL", "sorry \u2014 good driver. easy mistake when you're such an obvious, permanent, cock-sleeve sissy fucktoy"),
  ("NOBODY DIED", "the bar was on the floor and you cleared it, barely, you lucky, still-breathing, completely replaceable slut"),
  ("I'M ALMOST IMPRESSED", "almost. let's not get carried away, you pathetic, correctly owned, permanently broken little thing"),
  ("CLEAN RUN SO FAR", "which means you're overdue for a humiliating, public, permanently recorded fuck-up that everyone will see"),
  ("OH, WELL DONE", "do you want a sticker? a little chart? a gold star for the good little permanently broken, hole-trained faggot?"),
  ("A MOMENT OF COMPETENCE", "cherish it. it won't last. nothing good about you ever does, and it never, ever will. you are temporary competence wrapped in permanent failure"),
]
