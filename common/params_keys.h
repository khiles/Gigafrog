...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"AlwaysOnLateralHoldTime", {PERSISTENT, FLOAT, "1.5", "1.5", 1}},
    ...
    {"LaneCenteringTrim", {PERSISTENT, BOOL, "0", "0", 2}},
    {"LaneCenteringTrimGain", {PERSISTENT, FLOAT, "1.0", "1.0", 2}},
    ...
    {"LiveTuneOnroad", {PERSISTENT, BOOL, "0", "0", 3}},
    ...
    {"MapHazardAlert", {PERSISTENT, BOOL, "1", "0", 1}},
    ...
    {"RoadReferenceUI", {PERSISTENT, BOOL, "1", "0", 1}},
    ...
    {"ShowAdvisorySpeed", {PERSISTENT, BOOL, "1", "0", 1}},
    ...
    {"SpeedLimitExceededAlert", {PERSISTENT, BOOL, "0", "0", 1}},
    {"SpeedLimitExceededMargin", {PERSISTENT, FLOAT, "0", "0", 1}},
    ...
    {"TailgatingAlert", {PERSISTENT, BOOL, "0", "0", 1}},
